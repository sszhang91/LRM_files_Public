...
pyplot.register_cmap(cmap=colors.LinearSegmentedColormap('BWR',cdict))
...
pyplot.register_cmap(cmap=colors.LinearSegmentedColormap('BWR2',cdict))
...
pyplot.register_cmap(cmap=colors.LinearSegmentedColormap('BWR2_r',cdict))
...
for file in os.listdir(cmap_dir):
    if file.endswith('.csv'):
        ...
        pyplot.register_cmap(cmap=colors.LinearSegmentedColormap(cmap_name+'_2',cdit))
        ...
        pyplot.register_cmap(cmap=colors.LinearSegmentedColormap(cmap_name+'_r',cdit_r))
